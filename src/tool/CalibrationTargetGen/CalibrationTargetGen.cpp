 ...
 * Optifined with global error from float. You can edit parameters commented below.
 * 
...
// 显示器点距 (mm)
// screen model: 276E9FJAB
const float PIX_DISTANCE = 0.2331f;

constexpr int castToPixel(const float worldPos, const float pixDistance = PIX_DISTANCE) noexcept
{
